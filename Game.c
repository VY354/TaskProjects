...
int main()
{
	...
	system("clear");
	//задаем переменные для длины выражения, длины чисел, и изнасальный размер массива лоступных операций
...
//реалтзвация функции для построения последовательности операций, включая скобки
...
{	
	...
	//Если честно, я очень много вренени уже потратил на это задание, в особенности на на этот алгоритм и алгоритм счета выражения
	//И этот алгорим я писал по меньшей мере неделю назад, и не хочу внова вникать в то, как он работает
	//могу лишь сказать то, что расстановка скобок, как "(" ,так и ")" зависит от того, на какой позиции мы находимся
